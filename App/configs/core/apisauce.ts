...
// export const DEFAULT_HEADERS:any = {
//   Accept:  'application/json',
//   'Content-Type': 'application/json'
// }

// export const NONE: any = null
// export const CLIENT_ERROR: string = 'CLIENT_ERROR'
// export const SERVER_ERROR:string = 'SERVER_ERROR'
// export const TIMEOUT_ERROR: string ='TIMEOUT_ERROR'
...
// export const CANCEL_ERROR: string ='CANCEL_ERROR'
